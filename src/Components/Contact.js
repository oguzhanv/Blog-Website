         ...
         <div className="row">
            <div className="eight columns">
               ...
               <form action="" method="post" id="contactForm" name="contactForm">
                  ...
                  <div>
						   <label htmlFor="contactName">İsim <span className="required">*</span></label>
						   <input type="text" defaultValue="" size="35" id="contactName" name="contactName" onChange={this.handleChange}/>
                  </div>

                  <div>
						   <label htmlFor="contactEmail">Soyisim <span className="required">*</span></label>
           ...
           <div id="message-warning"></div>
                  ...
                  <i className="fa fa-check"></i>Mesajın gönderildi. Teşekkürler!<br />
				   </div>
           </div>
